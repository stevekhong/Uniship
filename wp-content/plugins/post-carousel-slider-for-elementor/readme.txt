...
> <strong><a href="https://psdtowordpressdev.com/xd-to-wordpress-theme-conversion/" target="_blank">Adobe XD To WordPress Conversion Service</a></strong>
...
* **Ignore Sticky Posts**
* **Order** Posts in **Ascending/Descending** Order
* **Order** Posts by **Publish Date, ID, Post Title, Post Name (Slug), Menu Order, Modified Date, Randomly, Number of Comments**
...
= 1.2.0 (04-08-22) =
# `Elementor\Widgets_Manager::register_widget_type` is soft deprecated since 3.5.0
# `elementor/widgets/widgets_registered` is soft deprecated since 3.5.0 
# Deprecated: _register_controls is deprecated since version 3.1.0! 
